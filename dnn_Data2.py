...
def LSUV_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.01, n_epochs=30,
             batch_size=1, n_hidden=20, n_hiddenLayers=1, verbose=True,
             dataset='ToTheano2.mat'):
    """
    Demonstrate stochastic gradient descent optimization for a multilayer
    perceptron
...
if __name__ == '__main__':
    ...
    scipy.io.savemat('dnnModel_data_Train3.mat', mdict={'tanhLayer0_W':classifier.hiddenLayers[0].W,
